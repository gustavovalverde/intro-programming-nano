...
parts_of_speech1 = ["PLACE", "PERSON", "PLURALNOUN", "NOUN", "NAME",
...
# Plays a full game of mad_libs. A player is prompted to replace words
# in ml_string, which appear in parts_of_speech with their own words.
